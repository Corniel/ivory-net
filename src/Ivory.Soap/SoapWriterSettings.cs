...
namespace Ivory.Soap
{
    ...
    {
        public static SoapWriterSettings v1_1 => new SoapWriterSettings { SoapVersion = SoapVersion.v1_1 };
        public static SoapWriterSettings v1_2 => new SoapWriterSettings { SoapVersion = SoapVersion.v1_2 };
